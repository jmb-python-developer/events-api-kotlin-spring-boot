...
interface ProviderClientPort {
    suspend fun fetchEvents(): List<ProviderEventDto> // Method name stays same for backward compatibility
}
...
data class ProviderProperties(
    val url: String = "https://provider.code-challenge.feverup.com/api/events", // Still events endpoint
